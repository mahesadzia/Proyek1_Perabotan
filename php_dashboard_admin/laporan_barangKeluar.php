...
<head>
    ...
    <link rel="stylesheet" href="laporan_barangkeluar.css">
...
<div class="sidebar" id="sidebar">
    ...
    <a href="laporan_barangkeluar.php" class="active"><i class="fas fa-chart-bar"></i> Laporan Barang Keluar</a>
...
<div class="main">
    <header>
        ...
        <div style="font-size:0.875rem;font-weight:500;color:#718096;" class="no-print">
    ...
    <div class="card">
        ...
        <div class="filter-form no-print">
            ...
            <a href="laporan_barangkeluar.php" style="text-decoration:none;">
